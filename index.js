...
const newString = string2[string2.indexOf("C")] + string2[string2.indexOf("O")].repeat(2) + string2[string2.indexOf("L")];
...
console.log(string3.repeat(4) + " Batmaaaaaan!")
...
const myFavoriteFruit = "kiwi";

const firstIndex = fruit.indexOf(myFavoriteFruit);
const lastIndex = firstIndex + myFavoriteFruit.length;

const favoriteFruit = fruit.slice(firstIndex, lastIndex);
